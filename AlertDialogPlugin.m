...
@implementation AlertDialogPlugin
...
extern "C"
{
    ...
    {
        [AlertDialogPlugin showAlertDialog3Button:[StringUtil charToNSString:title] message:[StringUtil charToNSString:msg] yesTitle:[StringUtil charToNSString:yes] noTitle:[StringUtil charToNSString:no] cancelTitle:[StringUtil charToNSString:cancel] callback:unitySendMessage];
    }
    
    // ボタン2個のAlertダイアログを出す
    void showAlertDialog2Button(char* title, char* msg, char* ok, char* cancel, UnitySendMessageFunc unitySendMessage)
    {
        [AlertDialogPlugin showAlertDialog2Button:[StringUtil charToNSString:title] message:[StringUtil charToNSString:msg] okTitle:[StringUtil charToNSString:ok] cancelTitle:[StringUtil charToNSString:cancel] callback:unitySendMessage];
    }
    
    // ボタン1個のAlertダイアログを出す
    void showAlertDialog1Button(char* title, char* msg, char* ok, UnitySendMessageFunc unitySendMessage)
    {
        [AlertDialogPlugin showAlertDialog1Button:[StringUtil charToNSString:title] message:[StringUtil charToNSString:msg] okTitle:[StringUtil charToNSString:ok] callback:unitySendMessage];
    }
